package io.ourglass.amstelbright2.services.logcat;
...
public class LogCatRotationService extends IntentService {
    ...
    public void onCreate(){
        Log.v("FINDME", "onCreate was called");
    }
    ...
    public static File generateNewLTFFileName(){
        ...
        String fileName = "logcat-" + OGSystem.uniqueDeviceId() + "-" + timeStr + ".txt";
     ...
     */
    public static void postOldLogFileToAsahi(File oldLogFile){
        ...
        protected Boolean doInBackground(File... files) {
            ...
            try {
                ...
                Request request = new Request.Builder()
                        .url(OGConstants.ASAHI_ADDRESS + ASAHI_LOG_UPLOAD_ENDPOINT)
                        .post(reqBody)
                        .build();
                ...
                if(!res.isSuccessful()) {
                    Log.e(TAG, "Posting old log file to asahi failed with code " + res);
